let config = {
    local:{
        identityMetadata: `https://login.microsoftonline.com/<non_prod_tenant>/.well-known/openid-configuration`, 
    ...
    prod:{
        identityMetadata: `https://login.microsoftonline.com/<prod_tenant>/.well-known/openid-configuration`, 
